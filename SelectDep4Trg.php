...
myform.action="SelectDep4trg.php?tag=2&ptype=1&mtype="+i;
myform.submit();
}
...
if(a==1) //Poling Person
{
myform.action="./PDFReport/TrainingFirst.php";
myform.submit();
}

if(a==3) //Micro Observer
{
myform.action="./PDFReport/TrainingMicro.php";
myform.submit();
}

if(a==4) //Counting
{
myform.action="./PDFReport/TrainingCounting.php";
myform.submit();
}
...
<tr><td colspan=2 align=Center bgcolor=#ccffcc ><font face=arial size=3>Department/Office Selection Form for Training Letter<br>
</font></b>
    </td></tr>
<tr>
<td align=right bgcolor=white><font color=black size=2 face=arial>Select Batch Category</font></td>
<td align=left bgcolor=white>
<select name="catg" style="font-family: Arial;background-color:white;color:black;font-size: 14px;width:200px" onchange="redirect(1)">
<option  value="0"><-Select->
<option <?php echo $Sel1;?> value="1">Poling Officer
<option <?php echo $Sel2;?> value="3">Micro Observer    
<option <?php echo $Sel3;?> value="4">Counting Batch    
...
?>
</select><font color=black size=2 face=arial>
...
$Dcode=$row[$ind][0];
$val=$objP->getTotTrainee($Dcode, $phase);
if($catg==1)
$totval=$objP->rowCount("Depcode=".$Dcode." and deleted='N' and Pollcategory in(1,2,3,4,5)");

if($catg==3)
$totval=$objP->rowCount("Depcode=".$Dcode." and deleted='N' and Pollcategory=7");

if($catg==4)
$totval=$objP->rowCount("Depcode=".$Dcode." and deleted='N' and Pollcategory in(1,2,3)");
...
$dis="";
if ($val>0) //Only thise which are selected at leaat one
{
    $i++;
?>
<tr>
...
<td align="center">
<input type="checkbox"  name="<?php echo $Dep;?>" id="<?php echo $Dep;?>" value="<?php echo $Dcode;?>"  onclick=Add('<?php echo $Dep;?>',<?php echo $val;?>) <?php echo $dis;?>>
</td> 
</tr>
<?php
} //if $val>0
...
<input type=button value="Print Report"  name=del onclick=validate()  style="font-family:arial; font-size: 14px ; background-color:orange;color:black;width:120px" disabled>
