...
if(i==1)
myform.action="./PDFReport/ViewRegisterinPDF.php?code="+b;


if(i==2)
myform.action="./PDFReport/ViewGroup4APRinPDF.php?code="+b;

if(i==3)
myform.action="./PDFReport/ViewIcardinPDF.php?code="+b;

if(i==4)
myform.action="./PDFReport/APPLetter.php?code="+b;
...
myform.action="Viewgroup4Apr.php?tag=2";
myform.submit();
}
...
<tr><td colspan=2 align=Center bgcolor=#ccffcc><font face=arial size=3>View APR for Poling Group<br></font><font face=arial color=red size=2></td></tr>
<?php $i=0; ?>
<tr>
...
<?php 
$str=" Code in(select distinct advance from polinggroup where Lac=".$lac.")"; //Change the condition for where clause accordingly
...
<tr><td align=center rowspan=2><font face=arial size=2><input type=checkbox name=mpdf id=mpdf checked=checked>In PDF</td>
<td align="left"><font size=2 face=arial>
...
View Payment Register(APR)&nbsp;
<input type="checkbox" name="blank" checked="checked" disabled>Display Blank figure
</td></tr>
<tr><td></td>
<td align="left"><font size=2 face=arial>
...
<tr><td></td>
<td align="left"><font size=2 face=arial>
<input type="radio" name="opt" onclick="enu(4)">
