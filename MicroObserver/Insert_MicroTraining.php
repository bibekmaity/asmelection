...
//$a_Phaseno=$_POST['Phaseno'];
$a_Phaseno=3; //Hardcode 3 for Micro Observer
...
if (!is_numeric($a_Phaseno))
$myTag++;
//$b_Groupno=$_POST['Groupno'];
$b_Groupno=$objTraining->maxGroupno(3);
...
$mmode=$mmode.$objTp->SelectMicro($a_Phaseno, $b_Groupno, $m_Pr,$a,$b,$c);
...
header( 'Location: Form_Microtraining.php?tag=1&mtype=100');
?>
<a href=Form_Microtraining.php?tag=1>Back</a>
</body>
</html>
