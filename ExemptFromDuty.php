...
if ( isNaN(a)==false && a!="")
{
myform.action="Exemptfromduty.php?tag=2&ptype=0";
myform.submit();
}
}
...
if ( isNaN(a)==false && a!="")
{
var data="Type=2&Slno="+document.getElementById('Slno').value;
...
{    
$mid=" with New ID ".$_SESSION['newid']."(Note down ID for prining App. Letter) "  ;  
$url="<a href=./PDFReport/Appletter.php?id=".$_SESSION['newid']." target=_blank>Print Appointment Letter</a>";    
}
else
{    
$mid="";    
...
echo $objUtility->alert("Cannot Change Group Since Third Level Randomisation in Process");
else
{
$_SESSION['update']=1;
$disref="";
...
{
$_SESSION['update']=0;  
echo $objUtility->alert("Person Selected is not in a Poling Group");
}
} 
...
<tr><td colspan=3 align=Center bgcolor=#ccffcc><font face=arial size=3>Enter Poling ID for Person Who is to be Exempted from Main Poling Duty<br></font><font face=arial color=red size=2>&nbsp;</font></td></tr>
<?php $i=0; ?>
<tr>
...
<tr><td valign="top" align="left"  height="200"><font color=black size=2 face=arial>
<?php
...
<input type=button value="Refresh"  name=Ref id=Ref onclick=go()  style="font-family:arial; font-size: 14px ; background-color:green;color:blue;width:120px" <?php echo $disref;?>>
