...
$b_Groupno=$objTraining->maxGroupno(4);
$mvalue[1]=$b_Groupno;
...
$mmode=$mmode.$objTp->SelectCountTrainee($a_Phaseno, $b_Groupno, $m_Pr, $n_P1, $o_P2,$a,$b,$c);
...
header( 'Location: Form_Ctraining.php?tag=1&mtype=100');
?>
<a href=Form_Ctraining.php?tag=1>Back</a>
</body>
</html>
