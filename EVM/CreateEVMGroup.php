...
document.getElementById('mtype').value=j;
}
...
function go()
{
var j=parseInt(document.getElementById('lac').value);
if(j>0)
{
...
if ($Sel=="G") //Create Main an Reserve Group
{
...
$objEvm->setCu_id($cuid);
$objEvm->setBu_id($buid);
...
<input type=text size="4" name="Res" id="Res" value="20" onchange="check('Res')"  <?php echo $dis1;?> >
</td>
<?php 
}?>
    <?php  $Sel="Sel".$rowcount; ?>
<td align=center><font face="arial" size="2">
<input type=radio name="Sel" id="Sel"  onclick=reload(<?php echo $row[$ii]['Code'];?>,"G")  <?php echo $dis1;?>>
</td>
<?php  $Clr="Clr".$rowcount; ?>
<td align=center><font face="arial" size="2">
<input type=radio name="Clr" id="Clr"  onclick=reload(<?php echo $row[$ii]['Code'];?>,"C")  <?php echo $dis2;?>>
</td>
<td align=center>&nbsp;
<?php if ($lock==true) {?>
...
<input type="hidden" size="1" name="lac" id="lac" value="0">  
<input type="hidden" size="1" name="mtype" id="mtype" value="0">  
<input type=button value=Process  name=Save1 onclick="go()" style="font-family:arial; font-size: 12px ;font-weight:bold; background-color:orange;color:black;width:100px">
</td></tr>
</table>
...
Avalialbale Control Unit for Selection-<b><font face=arial size=2 color=blue><?php echo $objCU->rowCount("Used='N'");?>/<font face=arial size=2 color=red><?php echo $objCU->rowCount("Used='N' or Used='Y'");?>
<br></b><font face=arial size=2 color=black>
Avalialbale Ballot Unit for Selection-<b><font face=arial size=2 color=blue><?php echo $objBU->rowCount("Used='N'");?>/<font face=arial size=2 color=red><?php echo $objBU->rowCount("Used='N' or Used='Y'");?>
