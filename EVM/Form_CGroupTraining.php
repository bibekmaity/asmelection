...
myform.action="../PDFReport/ViewGroupTrgBatchinPDF.php?phase=5&code="+b;    
myform.submit();
}
...
if (name == true)
{
myform.action="DeleteGroup.php?phase=5&group="+b;    
myform.submit();
}
}
}
...
{
myform.setAttribute("target", "_self");
myform.action="Form_CGrouptraining.php?tag=2&ptype=1&mtype="+i;
myform.submit();
}
...
myform.action="Insert_Cgrouptraining.php";
myform.submit();
}
else
...
{
$mvalue[0]="5";//Phaseno
$mvalue[1]=$objTraining->maxGroupno(5);
$mvalue[2]="";//Trgdate1
$mvalue[3]="";//Trgdate2
$mvalue[4]="";//Trgdate3
...
$mvalue[1]=$objTraining->MaxGroupno(5);//Groupno
$mvalue[2]="";//Trgdate1
$mvalue[3]="";//Trgdate2
$mvalue[4]="";//Trgdate3
...
<tr><td colspan=4 align=Center bgcolor=#ccffcc><font face=arial size=3><b>CREATE TRAINING SLOT FOR COUNTING GROUP BATCH NO <?php echo $mvalue[1]; ?></font><font face=arial color=red size=2><?php //echo  $_SESSION['msg'] ?></font></td></tr>
<?php $i=0; ?>
<tr>
...
<td align="center" width="15%"><font color=blue size=2 face=arial>Supervisor</td>
<td align="center" width="15%"><font color=blue size=2 face=arial>Assistant</td>
<td align="center" width="15%"><font color=blue size=2 face=arial>Static Observer</td>
</tr>
<tr>
...
$st="Supervisor-[".$objTp->mySelection(1, 5)."]";
$st=$st."<font color=black> Assistant-[</font>".$objTp->mySelection(2, 5)."]";
$st=$st." <font color=black>Static Observer-[</font>".$objTp->mySelection(3, 5)."]";
?>
...
<?php
$objTraining->setCondString(" phaseno=5");
