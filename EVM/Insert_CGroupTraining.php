...
$b_Groupno=$objTraining->maxGroupno(5);
$mvalue[1]=$b_Groupno;
...
$mmode=$mmode.$objTp->SelectCountGroupTrainee($a_Phaseno, $b_Groupno, $m_Pr, $n_P1, $o_P2,$a,$b,$c,$tot);
...
header( 'Location: Form_CGroupTraining.php?tag=1&mtype=100');
//echo $_SESSION['msg'];
?>
<a href=Form_CGroupTraining.php?tag=1>Back</a>
</body>
</html>
