...
{
$sql="select Hpc,Lac,Psno,Part_no,Psname,Address,Male,Female,Total,Rcode,Rnumber,Forthpoling_required,Reporting_tag from psname where Lac='".$this->Lac."' and Psno='".$this->Psno."'";
$result=mysql_query($sql);
$row=mysql_fetch_array($result);
if ($row)
{
...
{
$sql="insert into psname(Hpc,Lac,Psno,Part_no,Psname,Address,Male,Female,Total,Rcode,Rnumber,Forthpoling_required,Reporting_tag) values(";
if (strlen($this->Hpc)>0)
{
if ($this->Hpc=="NULL")
$sql=$sql."NULL";
...
{
$tRows=array();
$sql="select Hpc,Lac,Psno,Part_no,Psname,Address,Male,Female,Total,Rcode,Rnumber,Forthpoling_required,Reporting_tag from psname where ".$this->condString;
$i=0;
$result=mysql_query($sql);
