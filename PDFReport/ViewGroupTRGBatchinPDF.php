...
$rcount=0;
$objP=new Poling();
$str=" Slno in(select Poling_id from Poling_Training where Phaseno=".$mvalue[0]." and Groupno=".$mvalue[1].") order by Grpno,Pollcategory";
...
<td align="center"  width="8%">Group Code</td>
<td align="center"  width="8%">Poling ID</td>
<td align="center"  width="46%">Name & Designation of <br> Officer</td>
...
$rcode=1000+$row[$ii]['Grpno'];
$tbldata=<<<EOD
<tr>
<td align="center" height="$rheight" width="7%">$slno</td>
<td align="center" height="$rheight" width="8%">$rcode</td>
<td align="center" height="$rheight" width="8%">$colvalue[1]</td>
<td align="left" height="$rheight" width="46%">$colvalue[2]</td>
