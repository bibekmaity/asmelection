...
$objPolinggroup->setCondString("Reserve='Y' and lac=".$laccode." and Rcode>='".$a1."' and Rcode<='".$a2."'");
$totrec=$objPolinggroup->rowCount("Reserve='Y' and lac=".$laccode." and Rcode>='".$a1."' and Rcode<='".$a2."'");
...
REGISTER FOR  RESERVE POLING GROUP FOR <b>$laccode-$lacname</b>&nbsp;LAC
