...
if (isset($_POST['Signed'])) //Signed by DEO or Returning Officer
$Signed=$_POST['Signed'];
else
$Signed="D";
...
$phase=2;  //2 is for Group Training
...
$a2=0;
//echo $a1.".".$a2;
$cond=("lac=".$laccode." and Rcode>='".$a1."' and Rcode<='".$a2."'");
...
if ($prow[$mind]['Reserve']=="N")
$rcode=$prow[$mind]['Rcode'];
else
$rcode="Reserve";

$calldate=$prow[$mind]['Advance'];
...
if ($objP->isSelected4Trainee($pr, 2))
$trgrp=$prow[$mind]['Trggroup']; 
else
$trgrp=0;   
$page++;
...
if ($trgrp>0)
{
$trow=$objTrg->getTrainingDetail($pr, $phase);
...
{
$objUtility->UserPresent();
if ($prow[$j]['Grpno']>0 && $prow[$j]['Pollcategory']<6)  //selected for group   
{
$page++;    
$Slno=$prow[$j]['Slno'];
...
//New Addition  (Required for Tick Mark of Officer Concern
$mainrow[$index]['pr']=$pr;
$mainrow[$index]['p1']=$p1;
$mainrow[$index]['p2']=$p2;
$mainrow[$index]['p3']=$p3;
...
ORDER OF APPOINTMENT FOR PRESIDING AND POLLING OFFICER
</td>
</tr>
<tr>
...
<td align="center" width="$cwidth[0]">
 ...
 particulars of its location 
</td>
<td align="center" width="$cwidth[1]">
 Name of the Presiding Officer</td>
<td align="center" width="$cwidth[2]">
 Name of the Polling Officers
</td>
<td align="center" width="$cwidth[3]">
Polling officer authorized to 
perform the functions of the presiding officer in the latter's 
absence    
</td>
</tr>
<tr>
<td align="center" width="$cwidth[0]">1</td>
<td align="center" width="$cwidth[1]">2</td>
<td align="center" width="$cwidth[2]">3</td>
<td align="center" width="$cwidth[3]">4</td>
</tr>
EOD;
