...
$b_Groupno=$objTraining->maxGroupno(2);
$mvalue[1]=$b_Groupno;
...
//echo $m_Pr."-".$n_P1."-".$o_P2."-".$p_P3."-".$q_P4;

$_SESSION['mcheck']=$mcheck;
...
if ($result)
{
$objUtility->saveSqlLog("GroupTraining",$sql);  
$objUtility->Backup2Access("", $sql);
$objTp=new Poling_training();
$mmode=$mmode.$objTp->SelectGroupTrainee($a_Phaseno, $b_Groupno, $m_Pr, $n_P1, $o_P2, $p_P3, $q_P4,$a,$b,$c,$tot);
...
header( 'Location: Form_GroupTraining.php?tag=1&mtype=100');
//echo $_SESSION['msg'];
?>
<a href=Form_GroupTraining.php?tag=1>Back</a>
</body>
</html>
